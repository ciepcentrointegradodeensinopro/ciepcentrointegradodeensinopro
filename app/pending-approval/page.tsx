...
export default function PendingApprovalPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white flex flex-col items-center justify-center p-6 text-center">
      ...
      >
        <div className="size-24 bg-amber-500/10 rounded-full flex items-center justify-center mx-auto border-2 border-amber-500/20">
          <Clock className="w-12 h-12 text-amber-500 animate-pulse" />
        </div>

        <div className="space-y-4">
          <h1 className="text-3xl font-black tracking-tight">Aguardando Aprovação</h1>
          <p className="text-slate-400 leading-relaxed">
            Olá, <span className="text-white font-bold">{profile?.full_name || 'Estudante'}</span>! 
            Seu cadastro foi realizado com sucesso, mas por medidas de segurança, 
            sua conta precisa ser aprovada por um administrador antes de você acessar o sistema.
          </p>
        </div>
